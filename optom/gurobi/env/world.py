...
class World(object):
    ...
    def addVehicle(self, p_pos, p_desiredspeed):
        ...
        # TODO: Add constraints that if vehicle can't overtake or it's not sensible,
        # TODO: y > lanel length. => otl_s < y < otl_e || y > lane_len
        ...
        l_vehicle = optom.environment.vehicle.Vehicle(p_id=l_vid,
                                                      p_desiredspeed=l_var_ds,
                                                      p_posx=l_var_posx,
                                                      p_posy=l_var_posy,
                                                      p_y=l_var_y,
                                                      p_yt=l_var_yt,
    ...
    def min_overtaking_distance(self, p_vid_a, p_vid_b):
